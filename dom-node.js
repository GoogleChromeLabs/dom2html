...
module.exports = {
   ...
   * @param {dom-error-output} domErrorOutput A string defining error outputting 
   ...
   */
  createElemForNode: function (document, domErrorOutput, nodeLike) {
    switch (nodeLike.nodeType) {
      ...
      case NODE_TYPES.CDATA_NODE: //CDATA_NODE
        ...
        if (['all', 'comments'].includes(domErrorOutput)) {
          return document.createComment("unsupported element: " + JSON.stringify(nodeLike));
        } else {
